        ...
        <table class="table table-striped table-bordered table-list">
                ...
                <tr>
                        ...
                        <div class="dropdown">
                            ...
                            <li><a data-admin_role="deuty_register"data-action_type="approve"data-exam_roll="<?php echo $value["exam_roll"];?> "class="btn  approve_button"><em class="fa fa-check"></em> Approve</a></li>
                            </ul>
                        </div>
                        </td>
                    </tr>
