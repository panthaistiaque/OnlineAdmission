                    ...
                    <tr>
                        ...
                        <td text-align="center">
                            <div class="dropdown">
                                ...
                                <li><a href="female-hall-student.php">All Students</a></li>
                                <li><a href="female-hall-seat-plan.php">Seat Plan</a></li>
                                <li class="divider"></li>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center" id="myModalLabel">Add New Hall</h4>
            </div>
            <div class="modal-body">
                <form role="form">
                    ...
                    <div class="form-group">
                        <label for="inputName">Total Floor</label>
                        <input type="text" class="form-control" id="inputName" />
                    </div>
                </form>
            </div>
