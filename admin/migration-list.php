<?php $page_title = "Subject Migration List"; ?>
<?php $this_page = "migration"; ?>
...
<div class="col-lg-12">
    <h4>List Of Migration Processes</h4>
    <hr>
                ...
                <tbody>
                    <tr>
                        ...
                        <td text-align="center">
                            <a href="migration-student.php"class="btn btn-info"><em class="fa fa-list"></em></a>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center" id="myModalLabel">Create New Migration</h4>
            </div>
            <div class="modal-body">
                <form role="form">
                    <div class="form-group">
                        <label for="inputName">Migration Name</label>
