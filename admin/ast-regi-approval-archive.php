        ...
        <table class="table table-striped table-bordered table-list">
                ...
                <td><?= isset($value['exam_roll']) ? $value['exam_roll'] : '-' ?></td>
                        ...
                        <div class="dropdown">
                            ...
                            <li><a data-admin_role="asst_register"data-action_type="reset"data-exam_roll="<?php echo $value["exam_roll"];?> "class="btn  approve_button"><em class="fa fa-check"></em> Reset</a></li>
                            </ul>
                        </div>
                        </td>
                    </tr>
