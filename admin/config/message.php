...
<div class="row">
	<div class="col-sm-12">
		<div class="alert alert-danger message_error message_div" style="margin-bottom: 10px">
...
<div class="row">
	<div class="col-sm-12">
		<div class="alert alert-success text-center message_success message_div" style="margin-bottom: 10px">
